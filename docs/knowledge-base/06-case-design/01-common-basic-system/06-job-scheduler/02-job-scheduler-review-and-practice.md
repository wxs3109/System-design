...
This article does not introduce new knowledge, but only tests whether it is possible to leave the document and re-derive the design from stress and faults. Read [Progressive Design Mainline](01-job-scheduler-progressive-design-mainline.md) first, then close the document and complete it within 45–60 minutes.
...
| Outbox, Preemption, Lease or Old Worker | [Progressive Mainline Section 3–7](01-job-scheduler-progressive-design-mainline.md) |
| Sharding, scanning, or asynchronous link expansion | [Progressive Mainline Section 8](01-job-scheduler-progressive-design-mainline.md) |
