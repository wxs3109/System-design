...
| [05 Fan-out on Write (write-time distribution) version](../../../02-core-concepts/10-time-ordering-and-unique-id/README.md) | Eliminate duplication JOIN | FeedItem, Fan-out Job/Queue, follow_id, Canary Cutover (low traffic switching) | Celebrity Account's Write Amplification |
