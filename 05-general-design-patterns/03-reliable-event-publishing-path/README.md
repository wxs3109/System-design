...
This section explains how these components work together. For the principles of At-least-once Delivery, Idempotency and Retry, see [Synchronization, Asynchronous and Event-Driven] (../../02-Core Concepts/05-Synchronization, Asynchronous and Event-Driven/) and [Impotent, Retry and Deduplication] (../../02-Core Concepts/06-Impotence, Retry and Deduplication/); for Broker’s External Contract, see [Task Queue and Pub/Sub] (../../04-Infrastructure Component/06-Task Queue and Publish and Subscribe/) and [Event Streaming Platform] (../../04-Infrastructure Component/07-Event Streaming Platform/).
...
| tenant_id | Isolation, routing, auditing and current limiting |
...
Deduplication Retention must override possible Replay Window. The detailed strategy will not be repeated here, see [Message Idempotence, Deduplication and Out-of-Order] (../../02-Core Concepts/06-Impotence, Retry and Deduplication/03-Message Idempotence, Deduplication and Out-of-Order.md).
