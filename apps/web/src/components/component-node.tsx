...
import { Activity, Archive, CalendarClock, Cloud, Database, GitFork, Globe2, HardDrive, Layers3, RadioTower, Server, type LucideIcon } from 'lucide-react'
import { useWorkbenchStore, type WorkbenchNode } from '@/lib/store'

export const componentIcons: Record<string, LucideIcon> = { globe: Globe2, activity: Activity, 'calendar-clock': CalendarClock, 'git-fork': GitFork, server: Server, layers: Layers3, database: Database, 'hard-drive': HardDrive, 'radio-tower': RadioTower, archive: Archive, cloud: Cloud }
